...
class PurchaseStartReq(Model):
    ...
    def __init__(self, login=None, qr_code=None, vest_type=None):  # noqa: E501
        """PurchaseStartReq - a model defined in OpenAPI

        :param login: The login of this PurchaseStartReq.  # noqa: E501
        :type login: Login
    ...
    @property
    def login(self):
        """Gets the login of this PurchaseStartReq.


        :return: The login of this PurchaseStartReq.
        :rtype: Login
        """
        return self._login
    ...
    def login(self, login):
        """Sets the login of this PurchaseStartReq.


        :param login: The login of this PurchaseStartReq.
        :type login: Login
        """
        if login is None:
